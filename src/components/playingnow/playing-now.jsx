...
import Reapet from "@assets/svg/reapet";
import Shuffel from "@assets/svg/shuffel";
            ...
            <div className="pnow">
                ...
                <div className="item">
                    <div className="content">
                        <div className="name">
                            <h1 className={theme === "light" ? 'textDark' : 'textWhite'}>{location.state.name}</h1>
                            <p className={theme === "light" ? 'textLight' : ''}>{location.state.title}</p>
                        </div>
                    ...
                    <div className="playMusic">
                        <div className="time"><p className={theme === "light" ? 'textDark' : 'textWhite'}>{secondsToHms(currentTime)}</p> <p className={theme === "light" ? 'textDark' : 'textWhite'}>{secondsToHms(duration)}</p></div>
                        ...
                        <div className="musicBtn">
                            ...
                            <div className="pointer">{play ? <Pause pauseAudio={pauseAudio} /> : <FontAwesomeIcon className={theme === "light" ? 'textDark' : 'textWhite'} onClick={startAudio} style={{ fontSize: '30px' }} icon={faPlayCircle} />}</div>
